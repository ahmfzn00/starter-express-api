...
exports.doCharge = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('SB-Mid-server-kK4-W0-bWlDBymrWPmMYaBiu').toString('base64'); // Dummy Charge Token
...
exports.doChargeProd = function(req, res, next) {
  ...
  var chargeToken = 'Basic ' + new Buffer('Mid-server-1F2S7oSEaO6zlym9oFz8W7nR').toString('base64');
